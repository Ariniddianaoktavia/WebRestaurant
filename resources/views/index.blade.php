...
<body>
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#reservasi">Info</a>
                        </li>
                    ...
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h4" style="color: gray; padding-top:20px;padding-bottom: 20px">Faqih</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Sando</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-1" style="color:#5e493a;font-size: 40px ;">"Makanannya enak dan chinese foos , MANTAP."</h3>
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Dani</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div id="reservasi" class="container">
            <h2 class="display-4" style="text-align: center;color:#5e493a;padding:50px 0;">Info</h2>
                        ...
                        @if($islogin['login']=='pelanggan')
                            <div class="card">
                              <div class="card-body">
                                ...
                                <a href="{{URL('pelanggan/')}}" class="btn btn-primary">Dashboard</a>
                              </div>
                            </div>
                        @else
                            <div class="card">
        ...
        <div id="team" class="col-md-12" style="background-image:url({{ asset('resto/images/slide_3.jpg')}});background-size: cover;padding-bottom: 50px">
            <div class="container">
                ...
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/faqih.jpeg')}}" title="E32201131_Yusuf Muhammad Faqih" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/sando.jpg')}}" title="E32201197_Mirzando Dirgantaka" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/dani.jpeg')}}" title="E32201498_Rizqi Ramadani " class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/husnul.jpg')}}" title=" E32201132_Husnul Putri Candra Buana " class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/dian.jpg')}}" title="E32201226_Arinid Diana Oktavia " class="rounded img-responsive" style="cursor: pointer;">
                    </div>
